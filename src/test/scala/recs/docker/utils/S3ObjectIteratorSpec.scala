...
@DoNotDiscover
class S3ObjectIteratorSpec extends AnyFlatSpec with Matchers with LocalStackS3Buckets with BeforeAndAfterAll {
  ...
  private val amazonS3 = makeS3Client()

  override def beforeAll(): Unit = {
    super.beforeAll()
    S3TestUtils.createTestObjects(amazonS3, bucket, names ++ infolderNames)
  }
